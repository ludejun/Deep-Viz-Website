...
> [!NOTE]
> **The stack stays on React 15 + roadhog.**
>
> [roadhog](https://github.com/sorrycc/roadhog) stopped in 2019 (umi replaced it), and moving off it
> means swapping the build system under a 194-file site — a rewrite, not maintenance.
>
> The site itself **builds and runs fine** (verified on Node 20/22 in 2026), and is now deployed
