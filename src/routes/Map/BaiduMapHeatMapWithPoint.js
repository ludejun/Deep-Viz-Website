...
import { BaiduMapHeatMapWithPoint } from '../../components/src';
import Basic from '../Layout/WDBasic';
import { baseControlTableCfg } from './BaiduMapControlUtil';

export default class BaiduMapHeatMapWithPoints extends Basic {
  render() {
    const Source = [{
      parameter: 'style',
    ...
    const tableConfig = [
      { title: 'BaiduMapHeatMapWithPoint', subtitle: '', dataSource: Source },
    ...
    const pointList = [
      {
        ...
        location: { lng: 116.434579, lat: 39.924987 },
      },
      {
        name: () => (
          <div style={pointStyle}>
        ...
        icon: { url: require('../../components/src/assets/imgs/map_pin_work.png'), size: { width: 25, height: 28 } },
        location: { lng: 116.414579, lat: 39.904987 },
      },
    ];
    return (
      <div>
        <p className="container-header">BaiduMapHeatMapWithPoint&nbsp;百度地图热力图</p>
        ...
        <Card>
          ...
          <p className="sample-title">
            数据展示：自定义热力图数据；示例中同时展示了额外的两个POI点。
            <Icon
              type="arrows-alt"
          ...
          <div className="code-container">
            <Highlight className="JavaScript">
              <div style={{ whiteSpace: 'pre' }}>
                {`import { BaiduMapHeatMapWithPoint } from 'deep-viz';
// 创建虚假数据
const datas = [
  { lng: 116.418261, lat: 39.921984, count: 50},
  { lng: 116.423332, lat: 39.916532, count: 51},
